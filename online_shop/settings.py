...
CORS_ALLOW_ALL_ORIGINS = True  # Тільки для тестування, не використовуйте в продакшн
...
TEMPLATES = [
    {
        ...
        ],  # Додайте каталог шаблонів, якщо він у кореневій папці
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": [
        "goods.permissions.IsAdminOrReadOnly",  # Налаштуйте за потребою
    ],
